...
public class Stage2 extends Stage {
    ...
    private MovingBitmap obstacle1 = new MovingBitmap(R.drawable.floor01_2_2);
    private MovingBitmap obstacle2 = new MovingBitmap(R.drawable.floor01_2_4);
    private MovingBitmap obstacle3 = new MovingBitmap(R.drawable.floor01_2_3);
    private MovingBitmap obstacle4 = new MovingBitmap(R.drawable.floor01_2_5);
    private MovingBitmap obstacle5 = new MovingBitmap(R.drawable.floor01_2_6);
    private MovingBitmap obstacle6 = new MovingBitmap(R.drawable.floor01_2_7);
    private MovingBitmap obstacle7 = new MovingBitmap(R.drawable.floor01_2_8);
    ...
    public Stage2(){
        ...
        for(int i=0;i<numberOfFloor;i++){
            ...
            floor_y[i] = 321;
            floor[i] = new MovingBitmap(R.drawable.floor01_2);
        }
        background = new MovingBitmap(R.drawable.map02);
        ...
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),500,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),700,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),900,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_6),1100,280-obstacle4.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_6),1300,280-obstacle4.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),1520,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_6),1770,280-obstacle4.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_6),1920,280-obstacle4.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),2190,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),2230,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),2500,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_7),2670,320-obstacle6.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),2940,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_7),3130,320-obstacle6.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),3380,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_7),3640,320-obstacle6.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),3880,220-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),3940,220-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4000,200-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4060,200-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4120,180-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4180,180-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4240,160-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4300,160-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4360,140-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4420,140-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4480,140-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_2),4540,140-obstacle1.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_4),4730,320-obstacle2.getHeight());
        setObstacleLocation(new MovingBitmap(R.drawable.floor01_2_5),4950,280-obstacle4.getHeight());
    ...
    public void setVisible(boolean newVisible){
        ...
        visible = newVisible;
        for(int i=0;i<props.size();i++)
            props.get(i).setVisible(newVisible);
    }
}
